...
import { FileText, Upload, CheckCircle, Clock, AlertTriangle, Star, Send, ExternalLink } from 'lucide-react';
...
export function AssignmentPlayer({ assignmentId, lessonTitle, onClose, onComplete }: AssignmentPlayerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" style={{ animation: 'fadeIn 0.2s ease-out' }}>
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col" style={{ animation: 'slideUp 0.3s ease-out' }}>
                {/* Header */}
                <div className="px-6 py-4 bg-gradient-to-r from-orange-500 to-amber-600 text-white flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-orange-200">{lessonTitle}</p>
                        </div>
                    </div>
